...
#ifndef GOOGLE_PROTOBUF_INCLUDED_StringMessage_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_StringMessage_2eproto_2epb_2eh
...
/* @@protoc_insertion_point(class_definition:GaoProtobuf.StringMessage) */ {
 public:
  inline StringMessage() : StringMessage(nullptr) {}
  ~StringMessage() PROTOBUF_FINAL;
  ...
  StringMessage* New(::google::protobuf::Arena* arena = nullptr) const PROTOBUF_FINAL {
 ...
 private:
  ...
  static ::absl::string_view FullMessageName() { return "GaoProtobuf.StringMessage"; }
...
inline PROTOBUF_ALWAYS_INLINE void StringMessage::set_str(Arg_&& arg,
                                                     Args_... args) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.str_.Set(static_cast<Arg_&&>(arg), args..., GetArena());
  // @@protoc_insertion_point(field_set:GaoProtobuf.StringMessage.str)
}
inline std::string* StringMessage::mutable_str() ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline void StringMessage::set_allocated_str(std::string* value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_StringMessage_2eproto_2epb_2eh
